...
public class homeview {
    public JPanel init_panel(){
     ...
     text1.setFont(new Font("Lato", Font.PLAIN, 13));
     text1.setForeground(Color.decode("#D9D9D9"));
     gbc.gridy = 2;
     gbc.anchor = GridBagConstraints.CENTER;
     ...
     text2.setFont(new Font("Lato", Font.PLAIN, 13));
     text2.setForeground(Color.decode("#D9D9D9"));
     gbc.gridy = 3;
